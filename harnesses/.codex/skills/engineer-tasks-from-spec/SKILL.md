---
name: "engineer-tasks-from-spec"
description: "Create engineering implementation plan from product spec. Transforms product specs into phased implementation tickets ready for development."
---
...
1) **Validate Input**: Make sure you have been provided with the path to the feature documentation folder (e.g., `purple/documentation/251114-analytics-dashboard`). If not, complain immediately and abort.
...
5) **Invoke Engineering Architect**: Launch the `engineering-architect` agent with the following context:
   ...
   The engineering-architect is tasked to create a phased implementation plan with specific tickets that can be handed to implementation engineers.
