...
2) **DEVELOP HIGH LEVEL UNDERSTANDING** Read the user provided data model. It can be descriptive or in code, or both. Ask the user as many questions as you need to understand the desired model at a high level. Avoid nitty-gritty questions such as field level clarification, etc. 
